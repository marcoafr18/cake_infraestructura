...
class ProyectosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'accion' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'monto' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'anticipo' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'primeraEstimacion' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'segundaEstimacion' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'primeraEstimacion' => 1,
                'segundaEstimacion' => 1,
                'fechaInicio' => '2020-01-24',
                'fechaFin' => '2020-01-24',
                'created' => '2020-01-24 22:57:45',
                'modified' => '2020-01-24 22:57:45',
                'programa_id' => 1,
                'user_id' => 1,
            ],
        ];
